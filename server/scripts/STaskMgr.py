...
#                     next_task = self.get(self._current_task.taskName)
...
#     # def get(self, taskName: str, date: str = None, create: bool = False) -> Optional[STask_]:
#     #     """获取运行中的任务,如果没有且create=True则创建新任务
#     #     同一个应用的同名任务可以有多个实例
#     #     """
#     #     try:
#     #         # 从缓存中查找该应用下的所有运行中任务
#     #         task = STask_.get(self._device.id, taskName, date, create)
#     #         if task:
#     #             return task
